...
public class Scrabble {
	...
	public static String createHand() {
		String handString = MyString.randomStringOfLetters(HAND_SIZE - 2);
		handString = MyString.insertRandomly('a', handString);
		handString = MyString.insertRandomly('e', handString);
		return handString;
	}
